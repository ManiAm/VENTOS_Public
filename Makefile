...
LIBS = -L../veins/out/$(CONFIGNAME)/src -Lout/$(CONFIGNAME)/application/pedestrian -Lout/$(CONFIGNAME)/application/trafficLight -Lout/$(CONFIGNAME)/application/msg -Lout/$(CONFIGNAME)/application/rsu -Lout/$(CONFIGNAME)/application/bike -Lout/$(CONFIGNAME)/application/adversary -Lout/$(CONFIGNAME)/application/router -Lout/$(CONFIGNAME)/application/traci -Lout/$(CONFIGNAME)/application/vehicle -Lout/$(CONFIGNAME)/application/global  -lveins
LIBS += -Wl,-rpath,`abspath ../veins/out/$(CONFIGNAME)/src` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/pedestrian` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/trafficLight` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/msg` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/rsu` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/bike` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/adversary` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/router` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/traci` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/vehicle` -Wl,-rpath,`abspath out/$(CONFIGNAME)/application/global`
