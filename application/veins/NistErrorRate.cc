...
double
NistErrorRate::calculatePe (double p, uint32_t bValue)
{
...
double
NistErrorRate::getChunkSuccessRate (unsigned int datarate, enum Bandwidth bw, double snr_mW, uint32_t nbits)
{
